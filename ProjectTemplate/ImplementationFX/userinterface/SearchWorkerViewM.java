...
//==============================================================
public class SearchWorkerViewM extends View
{
    ...
    //----------------------------------------------------------
    public SearchWorkerViewM(IModel worker)
    {
        super(worker, "SearchWorkerViewM");
    ...
    private VBox createFormContent()
    {
        ...
        Text searchLabel = new Text(" Enter Workers First and/or Last Name: ");
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                myModel.stateChangeRequest("WorkerCollectionModifyView", p);
            }
        });
